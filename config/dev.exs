...
config :aurora, AuroraWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "z10rWUj9gYbWj5jkf8e6bBj7fEzYIYT8SOy9jp0IHg6C38NX3MmysRcSL+TD5vvK",
  watchers: [
...
config :aurora, AuroraWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/aurora_web/router\.ex$"E,
      ~r"lib/aurora_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]
